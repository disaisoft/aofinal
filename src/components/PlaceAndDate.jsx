        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <div className="col-12 col-lg-6 pt-4 pb-4 ">
                    ...
                    <a className="btn btn-outline-light " href="https://www.google.com/maps/place/Urgencias+Particulares+Odontol%C3%B3gicas+-+Alternativas+Odontol%C3%B3gicas/@6.2514293,-75.5874914,15z/data=!4m2!3m1!1s0x0:0x982efcdb680189e9?sa=X&ved=2ahUKEwjqy8uSj5XyAhXpEVkFHSXXBn8Q_BIwE3oECFsQBQ">Encuéntranos en Google Maps</a>
                </div>
            </div>
        </div>
